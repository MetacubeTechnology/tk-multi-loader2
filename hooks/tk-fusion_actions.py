...
class NukeActions(HookBaseClass):
    ...
    def generate_actions(self, sg_publish_data, actions, ui_area):
        ...
        if "loader" in actions:
            action_instances.append( {"name": "loader", 
                                      "params": None,
                                      "caption": "Create Loader Node", 
                                      "description": "This will add a loader node to the current comp."} )

        if "comp_import" in actions:        
            action_instances.append( {"name": "comp_import",
                                      "params": None, 
